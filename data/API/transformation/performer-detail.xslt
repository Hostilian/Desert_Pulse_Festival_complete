...
<xsl:template match="/festival"><xsl:for-each select="performers/performer[@id=$id]">{
  "id": "<xsl:call-template name="json-string"><xsl:with-param name="text" select="@id"/></xsl:call-template>", "name": "<xsl:call-template name="json-string"><xsl:with-param name="text" select="name"/></xsl:call-template>", "genre": "<xsl:call-template name="json-string"><xsl:with-param name="text" select="genre"/></xsl:call-template>", "country": "<xsl:call-template name="json-string"><xsl:with-param name="text" select="country"/></xsl:call-template>", "bio": "<xsl:call-template name="json-string"><xsl:with-param name="text" select="bio"/></xsl:call-template>"
